...
UICorner_15.CornerRadius = UDim.new(8, 8)
UICorner_15.Parent = Eei_3
...
UICorner_16.CornerRadius = UDim.new(8, 8)
UICorner_16.Parent = Eisc_3
...
UICorner_20.CornerRadius = UDim.new(8, 8)
UICorner_20.Parent = Eei_4
...
UICorner_21.CornerRadius = UDim.new(8, 8)
UICorner_21.Parent = Eisc_4
...
UICorner_24.Parent = Textboxxxx

Frame.Parent = HackFrame
Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Frame.Position = UDim2.new(0.0147991553, 0, 0.0150602404, 0)
...
UITextSizeConstraint_9.Parent = TextLabel
...
UITextSizeConstraint_10.Parent = TextLabel_2
...
UITextSizeConstraint_11.Parent = AutoFarm
...
UITextSizeConstraint_14.Parent = TextLabel_5
...
UITextSizeConstraint_15.Parent = TextButton
UITextSizeConstraint_15.MaxTextSize = 14

-- Scripts:

local function WDIYESN_fake_script() -- True.LocalScript 
...
coroutine.wrap(WDIYESN_fake_script)()
local function KRSU_fake_script() -- True.LocalScript 
	local script = Instance.new('LocalScript', True)
...
coroutine.wrap(KRSU_fake_script)()
local function MQQU_fake_script() -- False.LocalScript 
...
coroutine.wrap(MQQU_fake_script)()
local function VFSQ_fake_script() -- False.LocalScript 
	local script = Instance.new('LocalScript', False)
...
coroutine.wrap(VFSQ_fake_script)()
local function MCNO_fake_script() -- True_2.LocalScript 
...
coroutine.wrap(MCNO_fake_script)()
local function JKLJ_fake_script() -- True_2.LocalScript 
	local script = Instance.new('LocalScript', True_2)
...
coroutine.wrap(JKLJ_fake_script)()
local function NNSHRRT_fake_script() -- False_2.LocalScript 
...
coroutine.wrap(NNSHRRT_fake_script)()
local function EYIYMB_fake_script() -- False_2.LocalScript 
	local script = Instance.new('LocalScript', False_2)
...
coroutine.wrap(EYIYMB_fake_script)()
local function SJHF_fake_script() -- True_3.LocalScript 
...
coroutine.wrap(SJHF_fake_script)()
local function MBOCCR_fake_script() -- True_3.LocalScript 
	local script = Instance.new('LocalScript', True_3)
...
coroutine.wrap(MBOCCR_fake_script)()
local function CBPXL_fake_script() -- False_3.LocalScript 
...
coroutine.wrap(CBPXL_fake_script)()
local function VUASJNP_fake_script() -- False_3.LocalScript 
	local script = Instance.new('LocalScript', False_3)
...
coroutine.wrap(VUASJNP_fake_script)()
local function STQDUS_fake_script() -- True_4.LocalScript 
...
coroutine.wrap(STQDUS_fake_script)()
local function VRVY_fake_script() -- True_4.LocalScript 
	local script = Instance.new('LocalScript', True_4)
...
coroutine.wrap(VRVY_fake_script)()
local function ANKC_fake_script() -- False_4.LocalScript 
...
coroutine.wrap(ANKC_fake_script)()
local function VONSIRL_fake_script() -- False_4.LocalScript 
	local script = Instance.new('LocalScript', False_4)
...
coroutine.wrap(VONSIRL_fake_script)()
local function JNGDU_fake_script() -- AutoFarm.LocalScript 
	local script = Instance.new('LocalScript', AutoFarm)

	script.Parent.MouseButton1Click:Connect(function()
		if script.Parent.Parent.Parent.BGFrame.ScrollingFrame.Visible == false then
		script.Parent.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
		wait()
			script.Parent.Parent.Parent.BGFrame.ScrollingFrame.Visible = true
		elseif script.Parent.Parent.Parent.BGFrame.ScrollingFrame.Visible == true then
		script.Parent.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		wait()
			script.Parent.Parent.Parent.BGFrame.ScrollingFrame.Visible = false
		end	
	end)
end
coroutine.wrap(JNGDU_fake_script)()
local function USALUWI_fake_script() -- HackFrame.RGB_Script 
...
coroutine.wrap(USALUWI_fake_script)()
local function FNSYWEA_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(FNSYWEA_fake_script)()
